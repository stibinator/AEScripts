...
function buildUI(thisObj) {
  ...
  var imgFolder = 'first-n-last/'; //for debug
  ...
  if (pal !== null) {
    ...
    trimFirstnLast.onClick = function () {
      app.beginUndoGroup("trim to first and last layer")
    ...
    trimLast.onClick = function () {
      app.beginUndoGroup("trim to last layer")
    ...
    trimStartToCurrent.onClick = function () {
      app.beginUndoGroup("trim start to current time")
      trimToTime(app.project.activeItem.time, app.project.activeItem, true, extendLayersChkBx.value, recuseChkBx.value, doLockedchkBx.value);
      app.endUndoGroup();
    };
    trimEndToCurrent.onClick = function () {
      app.beginUndoGroup("trim end to current time")
      trimToTime(app.project.activeItem.time, app.project.activeItem, false, extendLayersChkBx.value, recuseChkBx.value, doLockedchkBx.value);
      app.endUndoGroup();
    };
  }
